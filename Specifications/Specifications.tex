...
& \\
\textbf{MFR020} & \textbf{High \gls{performance} \gls{om}}\\                                     
...
& The software can calculate the \gls{power consumption} of a given \gls{nn}, \gls{om} and \gls{dp}.\\
\textbf{MFR024} & \textbf{Calculator for \gls{performance}}\\                                     
& The software can calculate the \gls{performance} of a given \gls{nn}, \gls{om} and \gls{dp}.\\
\end{tabular}
...
\textbf{MFR020} & \textbf{High \gls{performance} \gls{om}}\\                                     
& An \gls{om} to perform calculations as fast as possible.\\
\textbf{MFR021} & \textbf{Low \gls{power consumption} \gls{om}}\\                                     
& An \gls{om} to perform calculations with low \gls{power consumption}.\\
\textbf{MFR022} & \textbf{Have high energy efficiency \gls{om}}\\                                     
& An \gls{om} to perform calculations at an optimal ratio between \gls{performance} and \gls{power consumption}.\\
\textbf{MFR023} & \textbf{Calculator for \gls{power consumption}}\\                                     
...
\textbf {MFR025} & \textbf{Dispatching the calculation process defined from the \gls{om}}\\
...
& \\
\textbf{MFR090} & \textbf{Choosing \gls{om}}\\
& Testet with: Implements: \\
...
& \\
\textbf{T020} & \textbf{High \gls{performance} \gls{om}}\\
...
& \\
\textbf{T021} & \textbf{Low \gls{power consumption} \gls{om}}\\
...
\newpage
\begin{tabular}{p{2cm}p{12cm}}
\textbf{T022} & \textbf{High energy efficiency \gls{om}}\\
...
& \\
\textbf{T090} & \textbf{Choosing \gls{om}}\\
...
\newpage
\begin{tabular}{p{2cm}p{12cm}}
\textbf{T110} & \textbf{Train \gls{nn} for classification of imageset}\\
...
\begin{tabular}{p{2cm}p{12cm}}
& \\
\textbf{T120} & \textbf{Showing topology of a \gls{nn}}\\
