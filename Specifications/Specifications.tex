...
\newpage
\begin{tabular}{p{2cm}p{12cm}}
\textbf{T180} & \textbf{Choosing video in format .avi}\\
T180.1 & \textbf{State:} The software is running. \\
...
& \\
\textbf{T190} & \textbf{Connect with camera}\\
T190.1 & \textbf{State:} The software is running\\
...
& \\
\textbf{T191} & \textbf{Receive video stream from camera}\\
T191.1 & \textbf{State:} The software is running, a camera is connected to the host pc.\\
...
& \\
\textbf{T192} & \textbf{Apply classification for a certain amount of frames}\\
T192.1 & \textbf{State:} The software is running. A video source was choosen by the user. All network details were provided by the user. Classification was choosen by the user.\\
