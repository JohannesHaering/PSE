...
\textbf{MAC010} \hypertarget{MAC10} & \textbf{Image classification} \\
...
& \\
\textbf{MAC020}\hypertarget{MAC20} & \textbf{Running \gls{nn} on heterogeneous platforms} \\
...
& \\
\textbf{MAC030}\hypertarget{MAC30} & \textbf{Different \glspl{om}} \\
...
& \\
\textbf{MAC040}\hypertarget{MAC40} & \textbf{Performance and \gls{power consumption} prediction}\\
...
& \\
\textbf{MAC050} \hypertarget{MAC50}& \textbf{GUI for interacting with software} \\
...
\begin{tabular}{p{2cm}p{11.4cm}}
\textbf{CAC070} \hypertarget{CAC70}& \textbf{Illustration of the topology of a \gls{nn}} \\
& The software is able to visualise the topology of a given \gls{nn} (see figure 9). \\
\textbf{CAC071} \hypertarget{CAC71} & \textbf{The visualised \gls{nn} can be saved}\\
& The visualized \gls{nn} is saved as a .png file in a chosen directory.\\
& \\
\textbf{CAC080}  \hypertarget{CAC80}& \textbf{Object Detection} \\
& The software can detect the \gls{bb} of an object. \\ 
& \\
\textbf{CAC090} \hypertarget{CAC90} &  \textbf{Using different models}\\
...
& The dropdown menu entries are: \glqq Single Image'', \glqq Folder\grqq, \glqq Camera\grqq, \glqq .txt file with \gls{img} paths\grqq.\\
& \\
...
& Tested with: Implements: \hyperlink{CAC160}{CAC160} \\
...
& Single \gls{img} sets the file selector on the same page to search for .jpg, .png, .bmp images\\
& Image Folder sets the file explorer on the same page to search for folder\\
& .txt File with \gls{img} Paths sets the file explorer on the same page to search for .txt files\\
...
& Tested with: Implements:  \hyperlink{CAC170}{CAC170}\\
