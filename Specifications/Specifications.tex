...
& If multiple images are processed, multiple .txt files will be created.\\
>>>>>>> 820a8e0d2cfeb958ece7475689a82bebf8bf52fb
& \\
...
& \textbf{Result:} The image is classified by the \gls{nn} and results are shown.\\
& \\
...
& \textbf{Result:} The calculations run with regard to balance between \gls{power consumption} and speed.\\
& \\
