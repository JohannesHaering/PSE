...
& Tested with: Implements \\
& The software should be able to send information about chosen image to different platforms. \\
& \\
...
The user U9 wants to classify his pictures for easy search. He has a ridiculously huge amount of images, so he wants to accelerate the classification as much as possible. U9 opens the Application, selects the set of pictures he wants to classify and finds selects the hardware he wants to use for it (for example FPGA). As a result the classifications are accelerated on the FPGA.
\clearpage
\subsection{Usecases}
