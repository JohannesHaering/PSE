/****************************************************************************
** Meta object code from reading C++ file 'topology.h'
**
...
#include "../../View/ViewModule/include/topology.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'topology.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(2, 31, 0) // ""
    ...
    "Topology\0on_pushButton_clicked\0"
};
...
void Topology::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Topology *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Topology::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_Topology.data,
    qt_meta_data_Topology,
    qt_static_metacall,
    nullptr,
    nullptr
} };
