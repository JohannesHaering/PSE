...
{
    std::string path = TESTDIR + "\\readdir\\TestNeuralNetworkRead.txt";
...
{
    auto path = TESTDIR + "\\readdir\\TestNeuralNetworkRead.txt";
...
TEST(SaveNeuralNetworkTest, valid)
{
    ...
    auto path = TESTDIR + "\\writedir\\TestNeuralNetworkWrite.txt";
