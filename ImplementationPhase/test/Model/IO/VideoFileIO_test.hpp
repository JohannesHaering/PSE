...
{
	VideoFileIO io = VideoFileIO();
	Data<cv::VideoCapture> input = io.readFile("/home/Documents/PSE/ImplementationPhase/build/testdata/readdir/testTXT.txt");
	cv::VideoCapture mat = input.getData();
	EXPECT_EQ(false, mat.isOpened());
}
...
{
	VideoFileIO io = VideoFileIO();
	EXPECT_THROW(io.readFile("/home/Documents/PSE/ImplementationPhase/build/testdata/readdir/NotExisting.avi"), std::ifstream::failure);
}
