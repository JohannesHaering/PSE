...
void ConvolutionLayer::setWeightsTensor(TENSOR(double) weights) { weightsTensor = weights; }
...
TENSOR(double) ConvolutionLayer::getWeightsTensor() { return weightsTensor; }
