...
void LocalResponseNormalizationLayer::setType(LRNType type) { this->depth = depth; }

void LocalResponseNormalizationLayer::setDepth(int depth) { this->depth = depth; }

LRNType LocalResponseNormalizationLayer::getType() { return type; }

int LocalResponseNormalizationLayer::getDepth() { return depth; }
