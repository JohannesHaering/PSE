...
void InferencePage::resultsChanged(std::string nnName, std::string imgName, std::string imgPath, std::string resultPath){
    ui->resultPanel->resultsChanged(nnName,imgName,imgPath,resultPath);
}
