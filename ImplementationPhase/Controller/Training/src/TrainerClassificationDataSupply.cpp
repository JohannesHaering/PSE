...
TrainerClassificationDataSupply::TrainerClassificationDataSupply(std::string directory, int width, int height, int channels)
{
    new TrainerDataSupply::TrainerDataSupply(directory, width, height, channels);
...
TrainerClassificationDataSupply::TrainerClassificationDataSupply(DATATYPE type)
{
    if (type == DATATYPE::EVENNOTEVEN)
    {
        ...
        {
            dataMap.insert(std::pair<std::string, cv::Mat>(std::to_string(i), *it));
...
ClassificationResult TrainerClassificationDataSupply::createResult(int i, std::vector<float> label)
{
    ...
    {
        probabilities.push_back(ClassProbability(std::to_string(j), *it))++ j;
    }
...
std::vector<float> TrainerClassificationDataSupply::createOutputVector(Result result)
{
