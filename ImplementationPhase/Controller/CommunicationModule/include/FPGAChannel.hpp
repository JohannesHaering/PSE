#ifndef FPGA_CHANNEL_H_
#define FPGA_CHANNEL_H_
#include <list>
...
class FPGAChannel {
  public:
    FPGAChannel(Device connectedDevice);
    FPGAChannel(Device connectedDevice, std::list<NeuralNetworkAdapter> neuralNetworkList);
